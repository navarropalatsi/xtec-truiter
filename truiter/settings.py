"""
Django settings for truiter project.
...
SECRET_KEY = 'django-insecure-cm3pj1g@*5+vmlf4x8n$%5$%u!1=&=txy1ifnko5dcc@pv6%8$'
...
WSGI_APPLICATION = 'truiter.wsgi.application'
